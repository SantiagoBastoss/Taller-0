...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pa�s de un atleta");
	...
	public void nacionalidadAtleta() 
	{
		String nombre = input("Digite el nombre del atleta: ");
		String pais = calculadora.paisAtleta(nombre);
		
		System.out.println("El pa�s del atleta " + nombre + " es " + pais);
	}
